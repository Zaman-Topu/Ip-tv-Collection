...
<!-- STATS:START -->
> **Last Checked:** 2026-06-19 09:13 PM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **3072** | 38.0% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **767** | 9.5% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **547** | 6.8% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3690** | 45.7% | Server offline, timed out, or returning errors globally. |
