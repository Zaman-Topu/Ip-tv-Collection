...
<!-- STATS:START -->
> **Last Checked:** 2026-06-20 06:08 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2951** | 37.2% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **767** | 9.7% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **577** | 7.3% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3645** | 45.9% | Server offline, timed out, or returning errors globally. |
