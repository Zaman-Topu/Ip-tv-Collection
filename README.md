...
<!-- STATS:START -->
> **Last Checked:** 2026-06-23 02:57 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2918** | 36.8% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **767** | 9.7% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **590** | 7.4% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3665** | 46.2% | Server offline, timed out, or returning errors globally. |
